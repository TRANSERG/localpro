...
const TESTIMONIALS = [
  {
    name: 'Café Avalon Team',
    role: 'Owner, Café Avalon, CIDCO Waluj Mahanagar 1',
    initials: 'CA',
    color: '#7B0A0A',
    rating: 5,
    text: 'Before VyapaarGrow, our café was invisible on Google Maps. Within 3 months, our calls doubled and walk-ins increased by 40%. The AI-generated food posts look absolutely stunning — our Instagram engagement has never been higher!',
  },
  {
    name: 'Annabrahma Owner',
    role: 'Owner, Annabrahma Chinese Corner, Bajaj Nagar',
    initials: 'AC',
    color: '#7B0A0A',
    rating: 5,
    text: 'The content studio creates beautiful Marathi food posts that match our brand perfectly. Every image feels like a professional shoot. Our Google rating improved and customers recognize us instantly from our social media presence.',
  },
  {
    name: 'Transerg LLP Team',
    role: 'Founder, Transerg LLP, AI & Mobile App Studio',
    initials: 'TL',
    color: '#C41E24',
    rating: 5,
    text: 'VyapaarGrow handles everything — Google Posts, social media posters, SEO keywords. The AI-generated tech posters match our brand identity perfectly. Our online visibility has grown significantly since we started.',
  },
  {
    name: 'Satisfied Business Owner',
    role: 'Local Business Owner, Chh. Sambhaji Nagar',
    initials: 'SB',
    color: '#8b5cf6',
    rating: 5,
    text: 'I was skeptical at first — I thought only big brands need SEO. But VyapaarGrow explained everything simply and the results speak for themselves. My shop now shows up on Google before businesses that have been here for decades.',
  },
]
